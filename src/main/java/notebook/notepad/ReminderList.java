...
import notebook.exceptions.WriteReadException;
import notebook.utils.FileTreatment;
...
public class ReminderList {
    ...
    private final URL PATH = LauncherNotepad.class.getClassLoader().getResource("Reminders.txt");
